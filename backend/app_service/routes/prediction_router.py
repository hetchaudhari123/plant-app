...
from services.prediction_service import predict_service, get_user_predictions, delete_prediction
...
class PaginationRequest(BaseModel):
    ...
    limit: int = Field(default=5, ge=1, le=1000, description="Maximum number of records to return")
    sort_by: str = Field(default="created_at", description="Field to sort by")
    sort_order: int = Field(default=-1, ge=-1, le=1, description="Sort order: -1 for descending, 1 for ascending")
