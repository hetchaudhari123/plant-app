...
def create_access_token(user_id: str, token_version: int) -> str:
    ...
    return jwt.encode(payload.model_dump(), settings.ACCESS_SECRET_KEY, algorithm=settings.JWT_ALGORITHM)
...
def create_refresh_token(user_id: str, token_version: int) -> str:
    ...
    return jwt.encode(payload.model_dump(), settings.REFRESH_SECRET_KEY, algorithm=settings.JWT_ALGORITHM)
